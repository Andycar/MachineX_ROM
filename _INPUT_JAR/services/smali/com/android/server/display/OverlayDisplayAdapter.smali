...
.method private updateOverlayDisplayDevicesLocked()V
    ...
    if-lt v6, v2, :cond_17b

    const/16 v2, 0x1000

    if-gt v6, v2, :cond_17b

    const/16 v2, 0x78

    if-lt v7, v2, :cond_17b

    const/16 v2, 0x1e0

    if-gt v7, v2, :cond_17b
    ...
    :try_end_16f
    .catch Ljava/lang/NumberFormatException; {:try_start_94 .. :try_end_16f} :catch_198
