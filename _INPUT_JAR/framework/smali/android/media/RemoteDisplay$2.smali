...
.method constructor <init>(Landroid/media/RemoteDisplay;Landroid/view/Surface;IIII)V
    ...
    iput-object p2, p0, Landroid/media/RemoteDisplay$2;->val$surface:Landroid/view/Surface;

    iput p3, p0, Landroid/media/RemoteDisplay$2;->val$width:I

    iput p4, p0, Landroid/media/RemoteDisplay$2;->val$height:I

    iput p5, p0, Landroid/media/RemoteDisplay$2;->val$flags:I

    iput p6, p0, Landroid/media/RemoteDisplay$2;->val$session:I
...
.method public run()V
    ...
    iget-object v1, p0, Landroid/media/RemoteDisplay$2;->val$surface:Landroid/view/Surface;

    iget v2, p0, Landroid/media/RemoteDisplay$2;->val$width:I

    iget v3, p0, Landroid/media/RemoteDisplay$2;->val$height:I

    iget v4, p0, Landroid/media/RemoteDisplay$2;->val$flags:I

    iget v5, p0, Landroid/media/RemoteDisplay$2;->val$session:I
