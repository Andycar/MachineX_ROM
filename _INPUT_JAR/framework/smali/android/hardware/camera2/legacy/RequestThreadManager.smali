...
.method private calculatePictureSize(Ljava/util/Collection;Landroid/hardware/Camera$Parameters;)Landroid/util/Size;
    ...
    :try_end_26
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_15 .. :try_end_26} :catch_27
    ...
    if-lt v13, v8, :cond_75

    invoke-virtual {v11}, Landroid/util/Size;->getHeight()I

    move-result v13

    if-lt v13, v7, :cond_75
...
.method private configureOutputs(Ljava/util/Collection;)V
    ...
    :try_end_37
    .catch Ljava/io/IOException; {:try_start_2c .. :try_end_37} :catch_106
    ...
    .line 356
    packed-switch v12, :pswitch_data_3ba
    ...
    :try_end_db
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_c0 .. :try_end_db} :catch_dc
    ...
    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_13f
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_11a .. :try_end_13f} :catch_dc
    ...
    :try_end_151
    .catch Ljava/lang/RuntimeException; {:try_start_141 .. :try_end_151} :catch_1f8
    ...
    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_1e6
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_1db .. :try_end_1e6} :catch_1e7
...
.method private resetJpegSurfaceFormats(Ljava/util/Collection;)V
    ...
    :try_end_18
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_15 .. :try_end_18} :catch_19
