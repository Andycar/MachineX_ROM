...
.method private static dumpDurationSteps(Ljava/io/PrintWriter;Ljava/lang/String;[JIZ)Z
    ...
    packed-switch v12, :pswitch_data_164
...
.method public final dumpCheckinLocked(Landroid/content/Context;Ljava/io/PrintWriter;IIZ)V
    ...
    packed-switch v5, :pswitch_data_ce8
...
.method public dumpCheckinLocked(Landroid/content/Context;Ljava/io/PrintWriter;Ljava/util/List;IJ)V
    ...
    :try_end_c9
    .catchall {:try_start_4d .. :try_end_c9} :catchall_d3
...
.method public dumpLocked(Landroid/content/Context;Ljava/io/PrintWriter;IIJ)V
    ...
    invoke-virtual/range {p2 .. p2}, Ljava/io/PrintWriter;->println()V
    :try_end_8e
    .catchall {:try_start_23 .. :try_end_8e} :catchall_cf
    ...
    invoke-virtual/range {p2 .. p2}, Ljava/io/PrintWriter;->println()V
    :try_end_d9
    .catchall {:try_start_d6 .. :try_end_d9} :catchall_c6
...
.method public final dumpLocked(Landroid/content/Context;Ljava/io/PrintWriter;Ljava/lang/String;IIZ)V
    ...
    packed-switch v6, :pswitch_data_1b6e
    ...
    if-eq v0, v1, :cond_1154

    const/16 v6, 0x3e8

    move/from16 v0, v147

    if-eq v0, v6, :cond_1154
    ...
    .line 3036
    .local v153, "val":I
    if-eqz v153, :cond_143e

    .line 3037
    if-nez v61, :cond_1441
    ...
    if-nez v124, :cond_1908

    if-eqz v100, :cond_18ba
    ...
    if-nez v124, :cond_1ada

    if-eqz v74, :cond_1aa4
