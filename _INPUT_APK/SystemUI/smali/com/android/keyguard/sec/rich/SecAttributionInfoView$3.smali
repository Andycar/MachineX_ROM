.class Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/keyguard/sec/rich/SecAttributionInfoView;->startActivityForCurrentUser(Landroid/content/Intent;Landroid/os/Bundle;Landroid/os/Handler;Ljava/lang/Runnable;)V
.end annotation
...
.method constructor <init>(Lcom/android/keyguard/sec/rich/SecAttributionInfoView;Landroid/content/Intent;Landroid/os/Bundle;Landroid/os/UserHandle;Ljava/lang/Runnable;)V
    ...
    iput-object p3, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$options:Landroid/os/Bundle;

    iput-object p4, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$user:Landroid/os/UserHandle;

    iput-object p5, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$onStarted:Ljava/lang/Runnable;
...
.method public run()V
    ...
    iget-object v3, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$intent:Landroid/content/Intent;

    iget-object v4, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$intent:Landroid/content/Intent;

    iget-object v5, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->this$0:Lcom/android/keyguard/sec/rich/SecAttributionInfoView;

    invoke-virtual {v5}, Lcom/android/keyguard/sec/rich/SecAttributionInfoView;->getContext()Landroid/content/Context;
    ...
    iget-object v10, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$options:Landroid/os/Bundle;

    iget-object v11, p0, Lcom/android/keyguard/sec/rich/SecAttributionInfoView$3;->val$user:Landroid/os/UserHandle;
