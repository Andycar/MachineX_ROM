...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 459
    .local v0, "count":I
    const-string v3, "MySettingsProvider"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "delete:uriMatcher.match(uri)="
    ...
    invoke-static {v3, v4}, Lcom/android/settings/favorite/LogMsg;->out(Ljava/lang/String;Ljava/lang/String;)V
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    const-string v7, "insert:uriMatcher.match(uri)="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-object v7, Lcom/android/settings/favorite/MySettingsProvider;->uriMatcher:Landroid/content/UriMatcher;
    ...
    invoke-static {v3, v6}, Lcom/android/settings/favorite/LogMsg;->out(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onCreate()Z
    ...
    .line 347
    const-string v5, "MySettingsProvider"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "onCreate():(mDB == null)? false:true  ="
    ...
    invoke-static {v5, v2}, Lcom/android/settings/favorite/LogMsg;->out(Ljava/lang/String;Ljava/lang/String;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string v3, "query:uriMatcher.match(uri)="
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v3, "update:uriMatcher.match(uri)="
